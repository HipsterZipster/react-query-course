...
// Mock data - using let for mutations
let users: User[] = [
...
const posts: readonly Post[] = [
  ...
  },
  {
    ...
    content:
      "TypeScript provides strong typing which helps prevent many common errors...",
    authorId: 2,
  ...
  },
  {
    ...
    content:
      "There are many approaches to state management in React applications...",
    authorId: 1,
  ...
  },
  {
    ...
    content:
      "Designing a good RESTful API requires careful consideration of resources and endpoints...",
    authorId: 4,
...
export const api = {
   ...
   * Delete a user
   */
  deleteUser: async (id: number, shouldError = false): Promise<void> => {
    await delay(600);
    if (shouldError) {
