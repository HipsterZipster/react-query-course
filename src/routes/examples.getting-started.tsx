  ...
  return (
    <div className="space-y-8">
      <section className="bg-white p-6 border rounded-lg">
        ...
        <p className="mb-4">
          To get started with TanStack Query, install the package:
        </p>
      ...
      <section className="bg-white p-6 border rounded-lg">
        ...
        <p className="mb-4">
          ...
          <code className="bg-gray-100 px-1 rounded">QueryClient</code> and wrap
          your application with{" "}
          <code className="bg-gray-100 px-1 rounded">QueryClientProvider</code>.
        </p>
  ...
  return (
    <QueryClientProvider client={queryClient}>
      ...
      <section className="bg-white p-6 border rounded-lg">
        ...
        <p className="mb-4">
          The React Query DevTools give you visibility into your queries and
          cache. They're essential for debugging and optimizing your
          application.
        </p>
        <CodeBlock language="tsx">
  ...
  return (
    <QueryClientProvider client={queryClient}>
      ...
      <ReactQueryDevtools initialIsOpen={false} />
        ...
        <p className="mt-2">
          The DevTools panel is visible at the bottom of this page. Try clicking
          on it to see the query cache in action.
        </p>
      </section>
    </div>
  );
