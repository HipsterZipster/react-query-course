    ...
    <div className="space-y-8">
      <header>
        ...
        <p className="text-gray-600">
          This example demonstrates why React Query matters for Java developers
          transitioning to front-end, showing the difference between traditional
      ...
      <section className="bg-white p-6 border rounded-lg">
        ...
        <p className="mb-4">
          In traditional React, managing server state requires manual handling
          of loading states, errors, and data caching. For Java developers, this
          is like manually writing JDBC code without using Hibernate or JPA.
        </p>
        <TraditionalExample />
      </section>
  ...
  return (
    <div className="border p-4 rounded bg-gray-50">
      ...
      <div className="mt-4 p-3 bg-yellow-50 rounded text-sm">
        <p>
          <strong>Analogy:</strong> This is like writing raw JDBC code where you
          manually:
        </p>
