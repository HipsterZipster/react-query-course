...
function BasicQueryExample(): React.ReactElement {
  ...
  return (
    <div className="space-y-8">
      <header>
        <h1 className="text-2xl font-bold mb-2">3. The useQuery Hook: Your New Best Friend</h1>
        <p className="text-gray-600">
          Learn the core concepts of querying data with React Query's useQuery hook.
        </p>
      </header>
        ...
        <div className="space-y-4 mb-6">
          <div className="p-4 border-l-4 border-blue-500 bg-blue-50">
            ...
            <p className="text-sm text-gray-700">
              A unique identifier for your data. Similar to a primary key in a database or a key in a HashMap.
            </p>
            <p className="mt-1 text-xs bg-blue-100 p-2 rounded">
              <strong>Java Analogy:</strong> Like a unique identifier in a Java Map or database primary key.
            </p>
          </div>
          ...
          <div className="p-4 border-l-4 border-green-500 bg-green-50">
            ...
            <p className="text-sm text-gray-700">
              The asynchronous function that fetches your data (e.g., using fetch or axios).
            </p>
            <p className="mt-1 text-xs bg-green-100 p-2 rounded">
              <strong>Java Analogy:</strong> This is like your DAO or Repository method that retrieves data from a database.
            </p>
          </div>
        </div>
  ...
  queryFn: fetchUsers
      ...
      <section className="bg-white p-6 border rounded-lg">
        ...
        <p className="text-sm text-gray-600 mb-4">
          This example uses React Query to fetch a list of users. Notice how loading, error states, and data are 
      ...
      <section className="bg-white p-6 border rounded-lg">
        <h2 className="text-xl font-semibold mb-4">Key Benefits Over Traditional Approach</h2>
  ...
  return (
    <div>
      ...
      <div className="mt-4 p-3 bg-blue-50 rounded text-sm">
        <p>
          <strong>Note:</strong> The query results are cached. Try navigating away and coming back - 
          the data will be instantly available while a background refetch occurs.
        </p>
      </div>
    </div>
  )
...
/**
 * Component to display a single query result property with description and Java analogy
 */
