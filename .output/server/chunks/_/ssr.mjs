...
import { createFileRoute, Link, ErrorComponent, lazyRouteComponent, notFound, createRootRouteWithContext, Outlet, HeadContent, Scripts, redirect, RouterProvider, useRouter, useMatch, rootRouteId as rootRouteId$1, createRouter as createRouter$1 } from '@tanstack/react-router';
  ...
  return createServerFnStaticCache({
    getItem: async (ctx) => {
      if (typeof document === "undefined") {
        ...
        const publicUrl = "/Users/ai/react-query-course/react-query-course/.output/public";
        const {
          promises: fs
...
async function loadVirtualModule(id) {
  switch (id) {
    ...
    case VIRTUAL_MODULES.startManifest:
      return await import('./_tanstack-start-manifest_v-s8sNOg2J.mjs');
    case VIRTUAL_MODULES.serverFnManifest:
      return await import('./_tanstack-start-server-fn-manifest_v-CCvkeKyP.mjs');
    default:
...
const appCss = "/assets/app-BkF-JLA6.css";
const seo = ({
  title,
  description,
  keywords,
...
const $$splitComponentImporter$j = () => import('./examples--2i-whzw.mjs');
const Route$j = createFileRoute("/examples")({
  component: lazyRouteComponent($$splitComponentImporter$j, "component")
});
const $$splitComponentImporter$i = () => import('./deferred-CdxJuQ03.mjs');
...
const $$splitComponentImporter$h = () => import('./_pathlessLayout-D9cZvqq2.mjs');
const Route$h = createFileRoute("/_pathlessLayout")({
...
const $$splitComponentImporter$g = () => import('./users.route-ec9uL_ud.mjs');
...
const fetchPost = createServerFn({
  method: "GET"
}).validator((d2) => d2).handler(fetchPost_createServerFn_handler, async ({
  data
}) => {
...
const $$splitComponentImporter$f = () => import('./posts.route-CCTF634a.mjs');
...
const $$splitComponentImporter$e = () => import('./index-CDaI40zk.mjs');
const Route$e = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$e, "component")
});
const $$splitComponentImporter$d = () => import('./users.index-DQWuf0Mz.mjs');
const Route$d = createFileRoute("/users/")({
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import('./posts.index-8K46EVme.mjs');
const Route$c = createFileRoute("/posts/")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitNotFoundComponentImporter$1 = () => import('./users._userId-v4qsB_3q.mjs');
const $$splitComponentImporter$b = () => import('./users._userId-DGh56O-J.mjs');
...
const $$splitComponentImporter$a = () => import('./posts._postId-C5T-yov6.mjs');
const $$splitNotFoundComponentImporter = () => import('./posts._postId-DX7OagJj.mjs');
...
const $$splitComponentImporter$9 = () => import('./examples.suspense-_haRgaBZ.mjs');
const Route$9 = createFileRoute("/examples/suspense")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import('./examples.introduction-4hd1a0eQ.mjs');
const Route$8 = createFileRoute("/examples/introduction")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import('./examples.getting-started-B8Rkptum.mjs');
const Route$7 = createFileRoute("/examples/getting-started")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import('./examples.conclusion-DFKMhmFF.mjs');
const Route$6 = createFileRoute("/examples/conclusion")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import('./examples.basic-query-DeVVK4XG.mjs');
const Route$5 = createFileRoute("/examples/basic-query")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import('./examples.advanced-queries-Bis6FR8i.mjs');
const Route$4 = createFileRoute("/examples/advanced-queries")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import('./_nested-layout-BfZSVE8c.mjs');
const Route$3 = createFileRoute("/_pathlessLayout/_nested-layout")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import('./posts_._postId.deep-U3OHZajD.mjs');
const $$splitErrorComponentImporter = () => import('./posts_._postId.deep-DFmdjhKs.mjs');
const Route$2 = createFileRoute("/posts_/$postId/deep")({
  loader: async ({
    params: {
      postId
    },
...
const $$splitComponentImporter$1 = () => import('./route-b-CVm3vQe0.mjs');
const Route$1 = createFileRoute("/_pathlessLayout/_nested-layout/route-b")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import('./route-a-DDIOWP5Y.mjs');
...
const ExamplesRoute = Route$j.update({
  id: "/examples",
  path: "/examples",
  getParentRoute: () => Route$l
});
...
const PathlessLayoutRoute = Route$h.update({
  id: "/_pathlessLayout",
  getParentRoute: () => Route$l
});
const UsersRouteRoute = Route$g.update({
  id: "/users",
  path: "/users",
  getParentRoute: () => Route$l
});
...
const ExamplesSuspenseRoute = Route$9.update({
  id: "/suspense",
  path: "/suspense",
  getParentRoute: () => ExamplesRoute
});
const ExamplesIntroductionRoute = Route$8.update({
  id: "/introduction",
  path: "/introduction",
  getParentRoute: () => ExamplesRoute
});
const ExamplesGettingStartedRoute = Route$7.update({
  id: "/getting-started",
  path: "/getting-started",
  getParentRoute: () => ExamplesRoute
});
const ExamplesConclusionRoute = Route$6.update({
  id: "/conclusion",
  path: "/conclusion",
  getParentRoute: () => ExamplesRoute
});
const ExamplesBasicQueryRoute = Route$5.update({
  id: "/basic-query",
  path: "/basic-query",
  getParentRoute: () => ExamplesRoute
});
const ExamplesAdvancedQueriesRoute = Route$4.update({
  id: "/advanced-queries",
...
const PostsPostIdDeepRoute = Route$2.update({
...
const ApiUsersServerRoute = ServerRoute$1.update({
  id: "/api/users",
  path: "/api/users",
  getParentRoute: () => rootServerRouteImport
});
const ApiUsersIdServerRoute = ServerRoute.update({
  id: "/$id",
  path: "/$id",
...
const ExamplesRouteChildren = {
  ExamplesAdvancedQueriesRoute,
  ExamplesBasicQueryRoute,
  ExamplesConclusionRoute,
  ExamplesGettingStartedRoute,
  ExamplesIntroductionRoute,
  ExamplesSuspenseRoute
};
const ExamplesRouteWithChildren = ExamplesRoute._addFileChildren(ExamplesRouteChildren);
const ApiUsersServerRouteChildren = {
  ApiUsersIdServerRoute
};
const ApiUsersServerRouteWithChildren = ApiUsersServerRoute._addFileChildren(ApiUsersServerRouteChildren);
...
export { NotFound as N, PostErrorComponent as P, Route$b as R, userQueryOptions as a, Route$a as b, postQueryOptions as c, Route$2 as d, serverEntry as default, createServerRpc as e, createServerFn as f, postsQueryOptions as p, usersQueryOptions as u };
